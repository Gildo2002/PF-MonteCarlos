...
public class tabs3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_tabs3, container, false);

        button = (Button) view.findViewById(R.id.btn_tabs3_show);
        editText01 = (EditText) view.findViewById(R.id.et_tabs3_v01);
        editText02 = (EditText) view.findViewById(R.id.et_tabs3_v02);
        editText03 = (EditText) view.findViewById(R.id.et_tabs3_v03);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    String value_c = editText03.getText().toString();
                    ...
                    boolean trust =  (SimpleValidator.validate(SimpleValidator.NOT_EMPTY,
                            ...
                            SimpleValidator.validate(SimpleValidator.NOT_EMPTY,
                            value_c) &&
                            Double.valueOf(value_c) > 0);

                    if(trust){
                        calculateNumExp(Double.valueOf(value_a),Double.valueOf(value_b),Double.valueOf(value_c));
                    }
                    else
    ...
    private void calculateNumExp(Double value_a, Double value_b, Double value_c){

        anyChartView = view.findViewById(R.id.any_chart_view_tabs3);
        APIlib.getInstance().setActiveAnyChartView(anyChartView);
        anyChartView.setProgressBar(view.findViewById(R.id.progress_bar_tabs3));

        List<Double> number = new ArrayList<>();

        for(int i=0;i<100;i++) {
            double result = ExpRandom.generadorDistribucionTriangular(value_a,value_b,value_c);
            number.add(result);
        }
