package com.decagon.pf_montecarlos.ui.main;
...
public class PlaceholderFragment extends Fragment {
    ...
    public static Fragment newInstance(int index) {
        ...
        switch (index){
            case 1: fragment = new tabs1();break;
            case 2: fragment = new tabs2();break;
            case 3: fragment = new tabs3();break;
            case 4: fragment = new tabs4();break;
        }
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_number_exp_random, container, false);
